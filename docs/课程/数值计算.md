...
- [实验手册](../assets/courses/数值计算/MATLAB实验手册.pdf)
- 课本 [百度网盘](https://pan.baidu.com/s/1dhOEYK2pXsYBk-Bldh32dA?pwd=mdu4)

### 个人参考答案

- [实验报告(pdf)](../assets/courses/数值计算/main.pdf)
- [实验报告(matlab)](../assets/courses/数值计算/main.mlx)：实时脚本，直接用matlab打开即可。导出实验报告建议先转换成word，再用word导出pdf
- [课后习题](../assets/courses/数值计算/exercise.pdf)

## 历史表格记录（待核对）

以下为迁移前相互矛盾或归属不明的原始记录，未据此猜定课程关系：

- 本科生总览：学分「空」、学期「空」、修读情况「电信必修」、资料情况「较完善✅」
